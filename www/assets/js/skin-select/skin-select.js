$(document).ready(function() { 
	...
	$("#skin-select #toggle").click(function() { 
		  ...
		  angular.element(document.getElementById('onlineCtrl')).scope().refreshNGMap();
		...
		if($(this).hasClass('active')) {
			...
			$('#skin-select').animate({ left:-210 }, 100);
			$('.skin-part').css({"visibility":"hidden"});

			

			$('.wrap-fluid').css({"width":"auto", "margin-left":"8px"});
